...
const Home = () => {
  ...
  const getMovies = async () => {
    ...
    const {
      ...
      "https://api.themoviedb.org/3/discover/tv?&page=1&language=ko&region=kr&sort_by=vote_count.desc&api_key=f76021076e8162ea929bd2cea62c6646"
    //   "https://api.themoviedb.org/3/tv/top_rated?language=ko&sort_by=vote_count.asc&api_key=250604987b9bcb91e2f812b87db35ebf"
    //   "https://api.themoviedb.org/3/movie/now_playing?language=ko&region=kr&page=1&sort_by=release_date.desc&api_key=250604987b9bcb91e2f812b87db35ebf"  
    );
